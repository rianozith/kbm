...
class KegiatanTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert('insert into kegiatans (
            nama_kegiatan, tanggal_kegiatan, jam_kegiatan, tempat_kegiatan, guru_id, ruangan_id ) 
        ...
        'ruangan_id' => $faker->numberBetween($min=1, $max=3),
        ]);
        }
